...
// fullname,username,pwd,created,urole,status,phonenumber,picture,region,street,levelofeducation 
// income,email,disability
const formSchema = z.object({
  fulname: z.string().min(2, { message: "Name  must be at least 2 characters.",  }),
  username: z.string().min(2, {message: "Username must be at least 2 characters.",}),
  pwd: z.string().min(6, { message: "Password must be at least 6 characters.", }),
  created: z.string().optional(), 
  urole: z.enum(["admin", "guest", "supporter"], {required_error: "Role is required.",}),
  status: z.enum(["active", "suspended", "pending", "disabled"], {required_error: "Status is required.",}),
  phonenumber: z.string().optional(),
  picture: z.string().optional(), 
  region: z.string().optional(),
  street: z.string().optional(),
  levelofeducation: z.enum(["primary", "secondary","degree","postgraduate","none", ], {required_error: "Level of education is required.",}),
  income: z.enum(["below_1000_tsh", "below_10000_tsh", "below_30000_tsh"], {required_error: "Income is required.",}),

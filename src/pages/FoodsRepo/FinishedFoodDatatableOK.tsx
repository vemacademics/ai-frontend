 // if (action=="add"){
    ...
    //       toast.error(response?.message || "Failed to update item. Please try again.");
    //     }
    //   } catch (error) {
    ...
    //   }
    //   // try {
    //   //   const response = await updateItem(data); // Assume createItem returns a response object
    //   //   // if (response?.success)  // Check success from the response

    //   //   if (response && response.success === true) {
    //   //     // Check success from the response
    //   //     reset(); // Reset the form after successful submission
    //   //     setisEModalOpen(false); // Close the modal after submission
    //   //     fetchItems(); // Fetch items again to update the list
    //   //     toast.success("Item Updated created successfully!"); // Show success message
    //   //   } else {
    //   //     toast.error("Failed to Update item. Please try again."); // Show error toast
    //   //     reset(); // Reset the form even if creation fails
    //   //     setIsModalOpen(false); // Close the modal after submission
    //   //   }
    //   // } catch (error) {
...
import { deleteItem } from "@/serviceSection/itemService";
// import { toast } from "react-toastify";
